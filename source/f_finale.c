 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: f_finale.c,v 1.5.2.1 2002/07/20 18:08:34 proff_fs Exp $
 *
...
static const char
rcsid[] = "$Id: f_finale.c,v 1.5.2.1 2002/07/20 18:08:34 proff_fs Exp $";
...
void F_StartFinale (void)
{
  ...
  switch ( gamemode )
  {
    ...
    case retail:
    {
      S_ChangeMusic(mus_end, true);	//kaiser
...
static const castinfo_t castorder[] = { // CPhipps - static const, initialised here
  { &s_CC_ZOMBIE,  MT_PLAYER },
  { &s_CC_SHOTGUN, MT_PLAYER },
  { &s_CC_HEAVY,   MT_PLAYER },
  { &s_CC_IMP,     MT_PLAYER },
  { &s_CC_DEMON,   MT_PLAYER },
  { &s_CC_LOST,    MT_PLAYER },
  { &s_CC_CACO,    MT_PLAYER },
  { &s_CC_HELL,    MT_PLAYER },
  { &s_CC_BARON,   MT_PLAYER },
  { &s_CC_ARACH,   MT_PLAYER },
  { &s_CC_PAIN,    MT_PLAYER },
  { &s_CC_REVEN,   MT_PLAYER },
  { &s_CC_MANCU,   MT_PLAYER },
  { &s_CC_ARCH,    MT_PLAYER },
  { &s_CC_SPIDER,  MT_PLAYER },
  { &s_CC_CYBER,   MT_PLAYER },
  { &s_CC_HERO,    MT_PLAYER },
  { NULL,         0}
  };
