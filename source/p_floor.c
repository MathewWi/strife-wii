 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: p_floor.c,v 1.7.2.3 2002/07/20 18:08:36 proff_fs Exp $
 *
...
static const char
rcsid[] = "$Id: p_floor.c,v 1.7.2.3 2002/07/20 18:08:36 proff_fs Exp $";
...
//
//==========================================================================
int EV_DoFloorAndCeiling(line_t * line, int ftype, int ctype)
{
	boolean floor;
	boolean ceiling;
	int secnum;
