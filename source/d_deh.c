...
//=========SeHacked Stuff===============kaiser
//Weapon catch names:
const char *s_GOTCROSSBOW = GOTCROSSBOW;
const char *s_GOTRIFLE   = GOTRIFLE;
const char *s_GOTMINI    = GOTMINI;
const char *s_GOTGRENADE  = GOTGRENADE;
const char *s_GOTFLAME    = GOTFLAME;
const char *s_GOTBLASTER  = GOTBLASTER;
const char *s_GOTBULLET	  =	GOTBULLET;
const char *s_GOTAMMO	  =	GOTAMMO;
const char *s_GOTARROWS	  =	GOTARROWS;
const char *s_GOTPARROWS  =	GOTPARROWS;
const char *s_GOTMINIM	  =	GOTMINIM;
const char *s_GOTMINIBOX  =	GOTMINIBOX;
const char *s_GOTGREN	  =	GOTGREN;
const char *s_GOTGREN2	  =	GOTGREN2;
const char *s_GOTCELL1	  =	GOTCELL1;
const char *s_GOTCELLPACK =	GOTCELLPACK;
//======================================
...
const char*	s_PEASNPC_1= PEASNPC_1;
const char*	s_PEASNPC_2= PEASNPC_2;
const char*	s_PEASNPC_3= PEASNPC_3;
const char*	s_PEASNPC_4= PEASNPC_4;
const char*	s_PEASNPC_5= PEASNPC_5;
const char*	s_PEASNPC_6= PEASNPC_6;
const char*	s_PEASNPC_7= PEASNPC_7;
const char*	s_PEASNPC_8= PEASNPC_8;
const char*	s_PEASNPC_9= PEASNPC_9;
const char*	s_PEASNPC_10= PEASNPC_10;

const char*	s_REBLNPC_1= REBLNPC_1;
const char*	s_REBLNPC_2= REBLNPC_2;
const char*	s_REBLNPC_3= REBLNPC_3;
const char*	s_REBLNPC_4= REBLNPC_4;
const char*	s_REBLNPC_5= REBLNPC_5;
const char*	s_REBLNPC_6= REBLNPC_6;
const char*	s_REBLNPC_7= REBLNPC_7;
const char*	s_REBLNPC_8= REBLNPC_8;
const char*	s_REBLNPC_9= REBLNPC_9;
const char*	s_REBLNPC_10= REBLNPC_10;

const char*	s_ACLENPC_1= ACLENPC_1;
const char*	s_ACLENPC_2= ACLENPC_2;
const char*	s_ACLENPC_3= ACLENPC_3;
const char*	s_ACLENPC_4= ACLENPC_4;
const char*	s_ACLENPC_5= ACLENPC_5;
const char*	s_ACLENPC_6= ACLENPC_6;
const char*	s_ACLENPC_7= ACLENPC_7;
const char*	s_ACLENPC_8= ACLENPC_8;
const char*	s_ACLENPC_9= ACLENPC_9;
const char*	s_ACLENPC_10= ACLENPC_10;

const char*	s_BEGGNPC_1= BEGGNPC_1;
const char*	s_BEGGNPC_2= BEGGNPC_2;
const char*	s_BEGGNPC_3= BEGGNPC_3;
const char*	s_BEGGNPC_4= BEGGNPC_4;
const char*	s_BEGGNPC_5= BEGGNPC_5;
const char*	s_BEGGNPC_6= BEGGNPC_6;
const char*	s_BEGGNPC_7= BEGGNPC_7;
const char*	s_BEGGNPC_8= BEGGNPC_8;
const char*	s_BEGGNPC_9= BEGGNPC_9;
const char*	s_BEGGNPC_10= BEGGNPC_10;

const char*	s_TMPRNPC_1= TMPRNPC_1;
const char*	s_TMPRNPC_2= TMPRNPC_2;
const char*	s_TMPRNPC_3= TMPRNPC_3;
const char*	s_TMPRNPC_4= TMPRNPC_4;
const char*	s_TMPRNPC_5= TMPRNPC_5;
const char*	s_TMPRNPC_6= TMPRNPC_6;
const char*	s_TMPRNPC_7= TMPRNPC_7;
const char*	s_TMPRNPC_8= TMPRNPC_8;
const char*	s_TMPRNPC_9= TMPRNPC_9;
const char*	s_TMPRNPC_10= TMPRNPC_10;

/* Ty 05/03/98 - externalized
 * cph - updated for prboom */
const char *savegamename = "svsfsav";
...
static const deh_strs deh_strlookup[] = {
  ...
  {&startup4,"STARTUP4"},
  {&startup5,"STARTUP5"},
{&s_PEASNPC_1,"PEASNPC_1"},
{&s_PEASNPC_2,"PEASNPC_2"},
{&s_PEASNPC_3,"PEASNPC_3"},
{&s_PEASNPC_4,"PEASNPC_4"},
{&s_PEASNPC_5,"PEASNPC_5"},
{&s_PEASNPC_6,"PEASNPC_6"},
{&s_PEASNPC_7,"PEASNPC_7"},
{&s_PEASNPC_8,"PEASNPC_8"},
{&s_PEASNPC_9,"PEASNPC_9"},
{&s_PEASNPC_10,"PEASNPC_10"},

{&s_REBLNPC_1,"REBLNPC_1"},
{&s_REBLNPC_2,"REBLNPC_2"},
{&s_REBLNPC_3,"REBLNPC_3"},
{&s_REBLNPC_4,"REBLNPC_4"},
{&s_REBLNPC_5,"REBLNPC_5"},
{&s_REBLNPC_6,"REBLNPC_6"},
{&s_REBLNPC_7,"REBLNPC_7"},
{&s_REBLNPC_8,"REBLNPC_8"},
{&s_REBLNPC_9,"REBLNPC_9"},
{&s_REBLNPC_10,"REBLNPC_10"},

{&s_ACLENPC_1,"ACLENPC_1"},
{&s_ACLENPC_2,"ACLENPC_2"},
{&s_ACLENPC_3,"ACLENPC_3"},
{&s_ACLENPC_4,"ACLENPC_4"},
{&s_ACLENPC_5,"ACLENPC_5"},
{&s_ACLENPC_6,"ACLENPC_6"},
{&s_ACLENPC_7,"ACLENPC_7"},
{&s_ACLENPC_8,"ACLENPC_8"},
{&s_ACLENPC_9,"ACLENPC_9"},
{&s_ACLENPC_10,"ACLENPC_10"},

{&s_BEGGNPC_1,"BEGGNPC_1"},
{&s_BEGGNPC_2,"BEGGNPC_2"},
{&s_BEGGNPC_3,"BEGGNPC_3"},
{&s_BEGGNPC_4,"BEGGNPC_4"},
{&s_BEGGNPC_5,"BEGGNPC_5"},
{&s_BEGGNPC_6,"BEGGNPC_6"},
{&s_BEGGNPC_7,"BEGGNPC_7"},
{&s_BEGGNPC_8,"BEGGNPC_8"},
{&s_BEGGNPC_9,"BEGGNPC_9"},
{&s_BEGGNPC_10,"BEGGNPC_10"},

{&s_TMPRNPC_1,"TMPRNPC_1"},
{&s_TMPRNPC_2,"TMPRNPC_2"},
{&s_TMPRNPC_3,"TMPRNPC_3"},
{&s_TMPRNPC_4,"TMPRNPC_4"},
{&s_TMPRNPC_5,"TMPRNPC_5"},
{&s_TMPRNPC_6,"TMPRNPC_6"},
{&s_TMPRNPC_7,"TMPRNPC_7"},
{&s_TMPRNPC_8,"TMPRNPC_8"},
{&s_TMPRNPC_9,"TMPRNPC_9"},
{&s_TMPRNPC_10,"TMPRNPC_10"},
...
{
  "Dontuseme",			 // .stringname	//dummy. don't use!
  "Amount",				 // .inv_amount	//kaiser
  "ID #",                // .doomednum
...
static const struct deh_mobjflags_s deh_mobjflags[] = {
  ...
  {"GIVEQUEST",       MF_GIVEQUEST}, // will pick up items
  ...
  {"NOALERT",     MF_NOALERT}, // player's dagger won't alert -kaiser
  ...
  {"GHOST",			MF_GHOST},//kaiser
  {"COLOR1",		MTF_SWAP1},
  {"COLOR2",		MTF_SWAP2},
  {"COLOR3",		MTF_SWAP3},
  {"COLOR4",		MTF_SWAP4},
  {"PEASANT",		MF_PEASANT},	//will still talk/respond even after you caused noise.
};
...
//==============Strife Types=======================
extern void A_RemoveElectricBolt();	//kaiser
extern void A_GunFlashThinker();	//kaiser
extern void A_ShowElectricBolt();	//kaiser
extern void A_FireArrowBolt();	//kaiser
extern void A_BoltAlarm();	//kaiser
extern void A_FireArrowPoison();	//kaiser
extern void A_BringUpBolt();	//kaiser
extern void A_FireRiffle();	//kaiser
extern void A_Explode2();		//kaiser
extern void A_FireGrenade();
extern void A_GrendadeTic();	//kaiser
extern void A_Explode3();	//kaiser
extern void A_Rocketpuff();	//kaiser
extern void A_FireFlameThrower();	//kaiser
extern void A_FireRaise();		//kaiser
extern void A_SpawnGrenadeFire();	//kaiser
extern void A_GPFireTic();	//kaiser
extern void A_BurnSpread();	//kaiser
extern void A_TorpedoSound();	//kaiser
extern void A_FireTorpedo();	//kaiser
extern void A_TorpedoExplode();	//kaiser
extern void A_GlassShatter();	//kaiser
extern void A_SigilSound();	//kaiser
extern void A_SigilBeginFire();	//kaiser
extern void A_SigilShock();	//kaiser
extern void A_SigilTrail();	//kaiser
extern void A_FireSigilWeapon();	//kaiser
extern void A_KeepSigilDrawing();	//kaiser
extern void A_Sigil_E_Action();	//kaiser
extern void A_Stand();			//kaiser
extern void A_AgrdAttack();	//kaiser
extern void A_BodyParts();		//kaiser
extern void A_Patrol();	//kaiser
extern void A_Burn();		//kaiser
extern void A_BurnScream();	//kaiser
extern void A_DropBurnFlesh();	//kaiser
extern void A_DropItem();	//kaiser
extern void A_ShadowOn();		//kaiser
extern void A_ShadowOff();	//kaiser
extern void A_PeasAttack();	//kaiser
extern void A_PeasFall();		//kaiser
extern void A_ObjectWatch();	//kaiser
extern void A_Alarm();		//kaiser
extern void A_ObjectChase();	//kaiser
extern void A_TurretReFire();	//kaiser
extern void A_BackSound();	//kaiser
extern void A_Wander();	//kaiser
extern void A_BeGone();	//kaiser
extern void A_AguardPain();	//kaiser
extern void A_PgrdAttack();	//kaiser
extern void A_PgrdShoot();	//kaiser
extern void A_ReavShoot();	//kaiser
extern void A_ReavAttack();	//kaiser
extern void A_StalkerThinker();	//kaiser
extern void A_StalkerDrop();	//kaiser
extern void A_StalkerAttack();	//kaiser
extern void A_StalkerSetLook();	//kaiser
extern void A_StalkerWalk();	//kaiser
extern void A_BarrelExplode();	//kaiser
extern void A_ActorRefire();	//kaiser
extern void A_SentinelAttack();	//kaiser
extern void A_Levitate();	//kaiser
extern void A_CrusaderAttack();	//kaiser
extern void A_CrusaderLeft();	//kaiser
extern void A_CrusaderRight();	//kaiser
extern void A_ActorRepeatFire();	//kaiser
extern void A_ProgrammerAttack();	//kaiser
extern void A_ProgrammerDie();	//kaiser
extern void A_ProgrammerGrab();	//kaiser
extern void A_ProgrammerSpecial();	//kaiser
extern void A_Sigil_A_Action();	//kaiser
extern void A_Sigil_A_Attack();	//kaiser
extern void A_ChainTend();	//kaiser
extern void A_PriestAttack();	//kaiser
extern void A_SpectureMelee();	//kaiser
extern void A_PriestDie();	//kaiser
extern void A_SpectureAttack();	//kaiser
extern void A_NodeChunk();	//kaiser
extern void A_HeadChunk();	//kaiser
extern void A_BishopAttack();	//kaiser
extern void A_Seeker();	//kaiser
extern void A_DropInqArm();	//kaiser
extern void A_InqShootGun();	//kaiser
extern void A_InqThinker();	//kaiser
extern void A_InqGrenade();	//kaiser
extern void A_InqFlyCheck();	//kaiser
extern void A_InqTakeOff();	//kaiser
extern void A_InqFly();	//kaiser
extern void A_InqGrenadeExplode();	//kaiser
extern void A_SpectureBReveal();	//kaiser
extern void A_SpectureDReveal();	//kaiser
extern void A_SpectureCAttack();	//kaiser
extern void A_OracleSpecial();	//kaiser
extern void A_ActorSpecialEvent();	//kaiser
extern void A_SpectureDAttack();	//kaiser
extern void A_ZombieInSpecialSector();	//kaiser
extern void A_SpawnZombie();	//kaiser
extern void A_SpectureEAttack();	//kaiser
extern void A_EntityChooseAttack();	//kaiser
extern void A_EntityBorn();	//kaiser
extern void A_SubEntitySpawn();	//kaiser
extern void A_DegninExplode();	//kaiser
extern void A_QuestExplode();	//kaiser
extern void A_QuestUpdate1();	//kaiser
extern void A_CloseShop();	//kaiser
extern void A_ClearSoundTarget();	//kaiser
extern void A_CrystalExplode();	//kaiser
extern void A_CrystalChuck();	//kaiser
extern void A_AcolyteSpecial();	//kaiser
extern void A_NewWorldWarp();	//kaiser
extern void A_TBeacon();
...
static const deh_bexptr deh_bexptrs[] = // CPhipps - static const
{
  ...
  //====================STRIFE===============================
  { A_RemoveElectricBolt,	"A_RemoveElectricBolt"},
  { A_GunFlashThinker,	"A_GunFlashThinker"},
  { A_ShowElectricBolt,	"A_ShowElectricBolt"},
  { A_FireArrowBolt,	"A_FireArrowBolt"},
  { A_BoltAlarm,	"A_BoltAlarm"},
  { A_FireArrowPoison,	"A_FireArrowPoison"},
  { A_BringUpBolt,	"A_BringUpBolt"},
  { A_FireRiffle,	"A_FireRiffle"},
  { A_Explode2,		"A_Explode2"},
  { A_FireGrenade,	"A_FireGrenade"},
  { A_GrendadeTic,		"A_GrendadeTic"},
  { A_Explode3,		"A_Explode3"},
  { A_Rocketpuff,	"A_Rocketpuff"},	
  { A_FireFlameThrower,	"A_FireFlameThrower"},
  { A_FireRaise,	"A_FireRaise"},	
  { A_SpawnGrenadeFire,	"A_SpawnGrenadeFire"},
  { A_GPFireTic,	"A_GPFireTic"},
  { A_BurnSpread,	"A_BurnSpread"},
  { A_TorpedoSound,	"A_TorpedoSound"},
  { A_FireTorpedo,	"A_FireTorpedo"},
  { A_TorpedoExplode,	"A_TorpedoExplode"},
  { A_GlassShatter,	"A_GlassShatter"},
  { A_SigilSound,	"A_SigilSound"},
  { A_SigilBeginFire,"A_SigilBeginFire"},	
  { A_SigilShock,	"A_SigilShock "},
  { A_SigilTrail,	" A_SigilTrail"},	
  { A_FireSigilWeapon,	"A_FireSigilWeapon "},	
  { A_KeepSigilDrawing,	" A_KeepSigilDrawing"},	
  { A_Sigil_E_Action,	"A_Sigil_E_Action"},	
  { A_Stand,	" A_Stand"},			
  { A_AgrdAttack,	"A_AgrdAttack"},	
  { A_BodyParts,	" A_BodyParts"},		
  { A_Patrol,	"A_Patrol"},	
  { A_Burn,	"A_Burn"},		
  { A_BurnScream,	"A_BurnScream"},	
  { A_DropBurnFlesh,	"A_DropBurnFlesh"},	
  { A_DropItem,	" A_DropItem"},	
  { A_ShadowOn,	" A_ShadowOn"},		
  { A_ShadowOff,	"A_ShadowOff"},	
  { A_PeasAttack,	"A_PeasAttack"},	
  { A_PeasFall,	"A_PeasFall"},		
  { A_ObjectWatch,	" A_ObjectWatch"},	
  { A_Alarm,	"A_Alarm"},		
  { A_ObjectChase,	"A_ObjectChase"},	
  { A_TurretReFire,	"A_TurretReFire"},	
  { A_BackSound,	"A_BackSound"},	
  { A_Wander,	"A_Wander"},	
  { A_BeGone,	"A_BeGone"},	
  { A_AguardPain,	"A_AguardPain"},	
  { A_PgrdAttack,	" A_PgrdAttack"},	
  { A_PgrdShoot,	"A_PgrdShoot"},	
  { A_ReavShoot,	"A_ReavShoot"},	
  { A_ReavAttack,	" A_ReavAttack"},	
  { A_StalkerThinker,	"A_StalkerThinker"},	
  { A_StalkerDrop,	"A_StalkerDrop"},	
  { A_StalkerAttack,	"A_StalkerAttack"},	
  { A_StalkerSetLook,	"A_StalkerSetLook"},	
  { A_StalkerWalk,	"A_StalkerWalk"},	
  { A_BarrelExplode,	"A_BarrelExplode"},	
  { A_ActorRefire,	"A_ActorRefire"},	
  { A_SentinelAttack,	"A_SentinelAttack"},	
  { A_Levitate,	"A_Levitate"},	
  { A_CrusaderAttack,	"A_CrusaderAttack"},	
  { A_CrusaderLeft,	" A_CrusaderLeft"},	
  { A_CrusaderRight,	"A_CrusaderRight"},	
  { A_ActorRepeatFire,	"A_ActorRepeatFire"},	
  { A_ProgrammerAttack,	"A_ProgrammerAttack"},	
  { A_ProgrammerDie,	"A_ProgrammerDie"},	
  { A_ProgrammerGrab,	" A_ProgrammerGrab"},	
  { A_ProgrammerSpecial,	"A_ProgrammerSpecial"},	
  { A_Sigil_A_Action,	"A_Sigil_A_Action"},	
  { A_Sigil_A_Attack,	"A_Sigil_A_Attack"},	
  { A_ChainTend,	"A_ChainTend"},	
  { A_PriestAttack,	"A_PriestAttack"},	
  { A_SpectureMelee,	"A_SpectureMelee"},	
  { A_PriestDie,	"A_PriestDie"},	
  { A_SpectureAttack,	"A_SpectureAttack"},	
  { A_NodeChunk,	" A_NodeChunk"},	
  { A_HeadChunk,	"A_HeadChunk"},	
  { A_BishopAttack,	" A_BishopAttack"},	
  { A_Seeker,	" A_Seeker"},	
  { A_DropInqArm,	" A_DropInqArm"},	
  { A_InqShootGun,	"A_InqShootGun"},	
  { A_InqThinker,	"A_InqThinker"},	
  { A_InqGrenade,	" A_InqGrenade"},	
  { A_InqFlyCheck,	"A_InqFlyCheck"},	
  { A_InqTakeOff,	"A_InqTakeOff"},	
  { A_InqFly,	" A_InqFly"},	
  { A_InqGrenadeExplode,	"A_InqGrenadeExplode"},	
  { A_SpectureBReveal,	"A_SpectureBReveal"},	
  { A_SpectureDReveal,	"A_SpectureDReveal"},	
  { A_SpectureCAttack,	"A_SpectureCAttack"},	
  { A_OracleSpecial,	"A_OracleSpecial"},	
  { A_ActorSpecialEvent,	"A_ActorSpecialEvent"},	
  { A_SpectureDAttack,	"A_SpectureDAttack"},	
  { A_ZombieInSpecialSector,	"A_ZombieInSpecialSector"},	
  { A_SpawnZombie,	"A_SpawnZombie"},	
  { A_SpectureEAttack,	" A_SpectureEAttack"},	
  { A_EntityChooseAttack,	"A_EntityChooseAttack"},	
  { A_EntityBorn,	" A_EntityBorn"},	
  { A_SubEntitySpawn,	"A_SubEntitySpawn"},	
  { A_DegninExplode,	" A_DegninExplode"},	
  { A_QuestExplode,	"A_QuestExplode"},	
  { A_QuestUpdate1,	" A_QuestUpdate1"},	
  { A_CloseShop,	"A_CloseShop"},	
  { A_ClearSoundTarget,	"A_ClearSoundTarget"},	
  { A_CrystalExplode,	"A_CrystalExplode"},	
  { A_CrystalChuck,	"A_CrystalChuck"},	
  { A_AcolyteSpecial,	"A_AcolyteSpecial"},	
  { A_NewWorldWarp,	" A_NewWorldWarp"},
  { A_TBeacon, " A_TBeacon"},
