 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: i_sound.c,v 1.16.2.5 2002/07/20 18:08:37 proff_fs Exp $
 *
...
static const char
rcsid[] = "$Id: i_sound.c,v 1.16.2.5 2002/07/20 18:08:37 proff_fs Exp $";
...
//fixed version of I_GetSfxLumpNum	-	kaiser
int I_GetVoiceLumpNum(const char* voice)
{
    char namebuf[9];
    sprintf(namebuf, voice);
    return W_GetNumForName(namebuf);
}
