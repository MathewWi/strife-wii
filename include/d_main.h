...
extern boolean clnovoice;	// checkparm of -novoice	//kaiser
extern boolean cldebug1;
extern boolean clstrifedemo;	//kaiser
extern boolean clremovehubfiles;
