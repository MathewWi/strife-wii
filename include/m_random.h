 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: m_random.h,v 1.3.2.1 2002/07/20 18:08:36 proff_fs Exp $
 *
...
typedef enum {
  ...
  pr_splash,		//kaiser
  pr_minimissile,	//kaiser
  pr_flamethrower,	//kaiser
  pr_minimissile2,	//kaiser
  pr_phburn,		//kaiser
  pr_agrdact,		//kaiser
  pr_agrdatk,		//kaiser
  pr_glass,			//kaiser
  pr_glassfly,		//kaiser
  pr_stand,			//kaiser
  pr_movefirethingy,	//kaiser
  pr_peasantdth,	//kaiser
  pr_peastics,		//kaiser
  pr_sigil_a,	//kaiser
...
int S_Random (void);	//kaiser
int F_Random (void);	//kaiser
