...
void M_StartConversation(int speech, char* name, int bye, int talk);
void M_StartDialog(int input, int paragraph);	//kaiser
void M_WriteDialog(int x,int y,int w,const char* string);
boolean onetimer;	//kaiser
int giveitem_yes;	//kaiser
int giveitem_no;	//kaiser
int updatelog;
boolean gotlog;
...
void M_StartMessage(const char *string,void *routine,boolean input);	//kaiser
void M_VerifyConversation(int ch);	//kaiser
