 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: p_map.h,v 1.5.2.1 2002/07/20 18:08:36 proff_fs Exp $
 *
...
#define CRUSADERRANGE	(264*FRACUNIT)
#define MISSILERANGE    (32*64*FRACUNIT)
#define USETHINGRANGE	(96*FRACUNIT)

#define JUMPGRAVITY     (8*FRACUNIT/NEWTICRATERATIO) //kaiser
#define MOBJJUMP     (4*FRACUNIT/NEWTICRATERATIO) //kaiser
...
void    SetLineTexture(line_t* line, int position, int texture);	//kaiser
...
extern mobj_t *BlockingMobj;		//kaiser
