...
int EV_SlidingDoorNoTag
( line_t* line,
  mobj_t* thing );

int EV_DoFloorAndCeiling
(line_t * line,
int ftype, int ctype);

int EV_DoSplitDoor
(line_t * line,
int ftype, int ctype, int amount);

#define MAX_TEXT_SIZE 1024
extern char LogMessage[MAX_TEXT_SIZE];	//kaiser
...
void P_MoveObjectInSector(mobj_t* thing);
...
void P_BreakingGlass(line_t* li);	//kaiser 1-13-06
