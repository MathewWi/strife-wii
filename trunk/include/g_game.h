 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: g_game.h,v 1.6.2.1 2002/07/20 18:08:34 proff_fs Exp $
 *
...
//This doesn't belong anywhere else! -kaiser
boolean killedprog;	//kaiser
...
boolean SavingSoundTarget;
boolean SavingPlayers;

boolean G_Responder(event_t *ev);
boolean G_CheckDemoStatus(void);
boolean G_CheckDemoStatus(void);
void G_PlayerRebornLoad(boolean slideshow);	//kaiser
void G_PlayerForceSave(void);
void G_DeathMatchSpawnPlayer(int playernum);
void G_InitNew(skill_t skill, int map);	//kaiser
void G_DeferedInitNew(skill_t skill, int map);	//kaiser
...
extern int	newmap;	//kaiser
extern int  newmapspot;	//kaiser
void G_ExitLevel(int map, int mapspot);	//kaiser
void G_DoTeleportNewMap(void);	//kaiser
...
extern int  key_jump;	//kaiser
extern int  key_showstat;	//kaiser
extern int	key_invleft;	//kaiser
extern int	key_invright;	//kaiser
extern int	key_dropinv;	//kaiser
extern int	key_useinv;	//kaiser
extern int	key_log;	//kaiser
extern int	key_showkeylist;	//kaiser
