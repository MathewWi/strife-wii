 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: p_pspr.h,v 1.3.2.1 2002/07/20 18:08:37 proff_fs Exp $
 *
...
void P_PlayerOnFire(struct player_s *player);	//kaiser
void P_UpdateSigilWeapon(struct player_s *player);
