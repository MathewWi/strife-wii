 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: d_event.h,v 1.3.2.1 2002/07/20 18:08:34 proff_fs Exp $
 *
...
typedef enum
{
  ...
  BT_JUMP		= 64,		//kaiser
  BT_SHOWSTATS = 16,		//kaiser -something's fishy around here....
...
//kaiser
#define AFLAG_DROP			1
#define AFLAG_INVLEFT		2
#define AFLAG_INVRIGHT			4
#define AFLAG_USEINV			8
#define AFLAG_STATUS			16
#define AFLAG_LOG				32
#define AFLAG_KEY				64
