 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: doomdata.h,v 1.4.2.2 2002/07/20 18:08:34 proff_fs Exp $
 *
...
#define ML_JUMPOVER				512		//kaiser

//jff 3/21/98 Set if line absorbs use by player
//allow multiple push/switch triggers to be used on one push
#define ML_PASSUSE      0x2000	//changed - kaiser

#define ML_TRANSPARENT	0x1000		//kaiser

#define ML_BLOCKALL		0x4000		//kaiser
