...
typedef struct
{
  ...
  short originy;
  short patch;
//  short unused1;         // unused in Doom but might be used in Phase 2 Boom
//  short unused2;        // unused in Doom but might be used in Phase 2 Boom
...
typedef struct
{
  ...
  short      width;
  short      height;
  byte       columndirectory[4];      // unused in Doom but might be used in Boom Phase 2
  short      patchcount;
...
typedef struct
{
	...
	short	originy;
	short	patch;
} strifemappatch_t;	//kaiser


// Strife texture set - kaiser
typedef struct
{
	char		name[8];
    boolean          unused;
  ...
  for (i=0 ; i<numtextures ; i++, directory++)
    {
      ...
      mtexture = (strifemaptexture_t *) ( (byte *)maptex + offset);	//kaiser
